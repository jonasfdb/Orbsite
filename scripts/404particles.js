...
const colors = [
  { hex: '#2f1b46', weight: 0.3 },
  { hex: '#652b6c', weight: 0.4 },
  { hex: '#cc385c', weight: 0.3 }
];
...
let max_marble_count = 80 + Math.floor(Math.random() * 30)
...
// Click/tap to pop and track pointer too
